...
static void LCD_Cmd_Write(uint8_t data);
static void LCD_Send_String (uint8_t *str);
...
void LCD_Gotoxy(uint8_t x, uint8_t y)
{
	switch (y)
	{
	case 0: LCD_Cmd_Write ((0x80 | 0x00) + x); break;
	case 1: LCD_Cmd_Write ((0x80 | 0x40) + x); break;
	}
}
